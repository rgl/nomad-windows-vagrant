...
$archiveUrl = 'https://dl.grafana.com/oss/release/grafana-7.3.5.windows-amd64.zip'
$archiveHash = 'b6142472b93aeaf3d5d5e66b889c5a058c0284440bd605f6a08392a0d62c941c'
